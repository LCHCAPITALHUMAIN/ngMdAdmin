...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            combine: {
                files: {
                    'build/ng-admin.min.css': [
                        ...
                        'src/javascripts/bower_components/mdi/css/materialdesignicons.min.css'
                    ]
                }
            }
        },
        ...
        copy: {
            ...
            webfont: {
                cwd: 'src/javascripts/bower_components/mdi/fonts/',
                src: ['**'],
                dest: 'assets/fonts/',
                expand: true
            },
        ...
        watch: {
            ...
            sass: {
                files: ['src/sass/*.scss'],
                tasks: ['compass:dev', 'concat:css', 'copy:fonts_dev', 'copy:css_dev', 'copy:webfont'],
                options: {
                    atBegin: true,
                    livereload: true
                }
